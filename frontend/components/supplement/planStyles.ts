...
export const planStyles = StyleSheet.create({
  ...
  // Summary Card
  summaryCard: { backgroundColor: '#FEE2E2', borderRadius: 16, padding: 16, marginBottom: 16, flexDirection: 'column', gap: 10 },
  ...
  reminderSaveBtn: { backgroundColor: '#D14953', borderRadius: 12, padding: 12, alignItems: 'center', marginTop: 12 },
  ...
  scheduleCount: { fontSize: 14, fontWeight: '600', color: '#D14953', backgroundColor: '#FEE2E2', width: 28, height: 28, borderRadius: 14, textAlign: 'center', lineHeight: 28 },
  ...
  scheduleItemDose: { fontSize: 14, fontWeight: '600', color: '#D14953' },
  scheduleNote: { fontSize: 12, color: '#8FA39B', marginTop: 8, fontStyle: 'italic' },

  // Phases
  phaseCard: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16, marginBottom: 12, borderLeftWidth: 4, borderLeftColor: '#D14953' },
  phaseHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 8 },
  phaseBadge: { backgroundColor: '#D14953', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  ...
  phaseNote: { fontSize: 13, color: '#D14953', lineHeight: 20, fontStyle: 'italic' },
  ...
  generateButton: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#D14953', borderRadius: 14, paddingHorizontal: 24, paddingVertical: 14, marginTop: 24 },
  generateButtonText: { color: '#FFFFFF', fontSize: 16, fontWeight: '600' },
  backLink: { marginTop: 16 },
  backLinkText: { fontSize: 14, color: '#D14953', textDecorationLine: 'underline' },
  ...
  reasonDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#D14953' },
