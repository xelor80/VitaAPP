...
BASE_URL = os.environ.get('EXPO_PUBLIC_BACKEND_URL', 'https://anamnesis-flow.preview.emergentagent.com')
...
class TestOnboardingAndNavigation:
    ...
    def test_onboarding_options_exist(self):
        ...
        print(f"SUCCESS: Onboarding options loaded - {len(data['diets'])} diets, {len(data['health_goals'])} goals")
