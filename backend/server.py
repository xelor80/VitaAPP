...
""" + json.dumps([{"product_id": p["product_id"], "name": p["name"], "description": p.get("description", ""), "tags": p.get("tags", []), "application_instructions": p.get("application_instructions", ""), "video_url": p.get("video_url", "")} for p in PRODUCT_CATALOG_IT], ensure_ascii=False, indent=2) + """
