...
- Regeln, Produkte, Inhalte, App-Konfiguration, Audit-Log (Listen)
...
Anlege-/Bearbeiten-Formulare (Rules/Products/Articles – Backend-CRUD besteht), Geräte-,
Übersetzungs- und Push-Kampagnen-Ansichten, 2FA, feineres RBAC-abhängiges Menü.
